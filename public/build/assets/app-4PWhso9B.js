...
`)+`
`+l);const y=_+h+o,S=_+l+a,M=tl(r,r.VERTEX_SHADER,y),R=tl(r,r.FRAGMENT_SHADER,S);r.attachShader(E,M),r.attachShader(E,R),t.index0AttributeName!==void 0?r.bindAttribLocation(E,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(E,0,"position"),r.linkProgram(E);function L(P){if(i.debug.checkShaderErrors){const N=r.getProgramInfoLog(E)||"",F=r.getShaderInfoLog(M)||"",H=r.getShaderInfoLog(R)||"",X=N.trim(),U=F.trim(),V=H.trim();let G=!0,ie=!0;if(r.getProgramParameter(E,r.LINK_STATUS)===!1)if(G=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,E,M,R);else{const ae=il(r,M,"vertex"),ve=il(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(E,r.VALIDATE_STATUS)+`
